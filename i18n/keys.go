...
const (
	...
	MsgRedemptionRewardInvalid     = "redemption.reward_invalid"
	MsgRedemptionInvalidPlan       = "redemption.invalid_plan"
	MsgRedemptionUsageLimitInvalid = "redemption.usage_limit_invalid"
)
