...
import { Route as DegradationIndexRouteImport } from './routes/degradation/index'
...
const DegradationIndexRoute = DegradationIndexRouteImport.update({
  id: '/degradation/',
  path: '/degradation/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/degradation/': typeof DegradationIndexRoute
...
export interface RootRouteChildren {
  ...
  DegradationIndexRoute: typeof DegradationIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/degradation/': {
      id: '/degradation/'
      path: '/degradation'
      fullPath: '/degradation/'
      preLoaderRoute: typeof DegradationIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  DegradationIndexRoute: DegradationIndexRoute,
